...
/*for (let i = 0; i < 10; i++) {
    document.write(`<div>some items</div>`);
}*/

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині

/*for (let i = 0; i < 10; i++) {
    document.write(`<div>asddsaasd ${i} </div>`);
}*/
...
//
/*let mas = [1 , 2 , 3 , 4 , 5 , 'a' , 'b' , 'c' , 'd' , 'e' , true, false , true , false , true ];
console.log(mas);*/
...
/*let mas = ['qwe', 'rty', 'qwerty', 'asd', 'fgh', 'asdfgh', 'zxc', 'zxcvbn', 'vbn', 'qaz']
for (let ma of mas) {
    console.log(ma);
}*/

// - Створити масив з 10 елементів будь-якого типу. Вивести в консоль всі його елементи в циклі.
/*let mas = ['qwe', 1, 'qwerty', 2, 3, 'asdfgh', 4, 'zxcvbn', 5, 'qaz']
...
/*let array = ['qwe', 1, true, 'asd', 2, false, 'zxc', 3, true, false];
...
/*let array = ['qwe', 1, true, 'asd', 2, false, 'zxc', 3, true, false];
for (let arrayElement of array) {
    if (typeof arrayElement === typeof arrayElement[0]) {
        console.log(arrayElement);
    }
}*/
...
for (let usersListElement of usersList) {
    ...
    document.write(`<p>City - ${usersListElement.address.street} </p>`)
    document.write(`<p>City - ${usersListElement.address.suite} </p>`)
    document.write(`<p>City - ${usersListElement.address.zipcode} </p>`)
    document.write(`</div>`)
    document.write(`</div>`)
}
document.write(`</div>`);*/
...
/*
-----------------------------------------------------------------------------------------------------------------------
                               A D D I T I O N A L 3 Перевірте, будь ласка*/
...
let arr = []
for (let i = 0; i < 20; i++) {
    let n = Math.floor(Math.random() * (732 - 8));
    arr[i] = n
}
console.log(arr);
*/
...
/*let p = [100,250,50,168,120,345,188]
for (let i = 0; i < p.length; i++) {
    var a = p[i]
    a = (a + ++a + ++a + ++a + ++a + ++a + ++a) / p.length
}
console.log(a);*/
//
...
/*let a = [1, 'vasya', 31, false, 2, 'petya', 30, true]
let r = []
for (let i = 0; i < a.length; i++) {
...
//
/*let arr = [];
for (const userElement of usersWithId) {
    for (const citiesElement of citiesWithId) {
        if (userElement.id === citiesElement.user_id){
            userElement.adress = citiesElement;
        }
    }
}
arr = usersWithId
